...
mutate(bndvi = (nir -r)/(nir + b)) %>%
mutate(gndvi = (nir -r)/(nir + g)) 
```
...
nematode_mods_sel_plots$splotbetter
```
...
allplots <- marrangeGrob(nematode_mods_sel_plots$splotbetter, 
                         nrow = 4, 
                         cols = 4
                         )
